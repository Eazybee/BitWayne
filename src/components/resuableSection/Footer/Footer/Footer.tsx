            ...
            <div>
              <a href="https://fb.com/">
                <LazyLoad debounce={false} offsetVertical={300}>
                  <img src={Facebook} alt="facebook icon" onLoad={imgOnLoad} className={loaded ? 'loaded' : ''} />
                </LazyLoad>
              </a>
              <a href="https://twitter.com/">
                <LazyLoad debounce={false} offsetVertical={300}>
                  <img src={Twitter} alt="Twitter icon" onLoad={imgOnLoad} className={loaded ? 'loaded' : ''} />
                </LazyLoad>
              </a>
              <a href="https://instagram.com/loadam.com.ng">
                <LazyLoad debounce={false} offsetVertical={300}>
                  <img src={Instagram} alt="Instagram icon" onLoad={imgOnLoad} className={loaded ? 'loaded' : ''} />
                </LazyLoad>
              </a>
            </div>
          </div>
